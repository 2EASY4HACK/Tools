...
echo figlet -f digital " InYourHeart " | lolcat
echo " Metasploit User "  | lolcat
echo " Langsung install ?(y/t)"
read -p " [ y ]> " " [ t ] > " gg;
if [ $gg = t ] || [ $gg = t ]
then
echo " Oke Bye-Bye " | lolcat"
fi
if [ $gg = y ] || [ $gg = y ]
then
clear
   ...
   echo "Metasploit Telah Terinstall Ketik ./msfconsole Oke Buat Jalaninnya"
fi